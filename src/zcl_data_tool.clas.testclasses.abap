...
CLASS lcl_test IMPLEMENTATION.
  METHOD int_table_to_range.
    ...
    ref_range = zcl_data_tool=>internal_table_to_range( i_table = ref_table ).
  ...
  METHOD char_table_to_range.
    ...
    ref_range = zcl_data_tool=>internal_table_to_range( i_table = ref_table i_sign = 'E' ).
    ASSIGN ref_range->* TO <fs_actual_range>.
  ...
  METHOD string_table_to_range.
    ...
    ref_range = zcl_data_tool=>internal_table_to_range( i_table = ref_table i_option = 'NE' ).
    ASSIGN ref_range->* TO <fs_actual_range>.
  ...
  METHOD struc_table_to_range.
    ...
    ref_range = zcl_data_tool=>internal_table_to_range( i_table = ref_table i_fieldname = 'VALUE' i_sign = 'E' ).
    ASSIGN ref_range->* TO <fs_actual_range>.
